        ...
        /***/ ((__unused_webpack_module, exports, __webpack_require__) => {
            ...
            function webViewerInitialized() {
                ...
                document.getElementById('highlighttext').addEventListener('click', function () {
                    ...
                    //below code is written by shivam
                    var x = document.getElementById("translateText");
                ...
                //below code Added by shivam
                document.getElementById('translateText').addEventListener('click', function () {
                    var modal = document.getElementById("myTranslateModal");
                    var span = document.getElementsByClassName("closeTranslateWindow")[0];
                    const selectElement =
                        document.querySelector('#lang');
                    //alert(selectElement.value);

                    span.onclick = function() {
                        console.log("span caleed");
                    ...
                    window.onclick = function(event) {
                        ...
                        if (event.target == modal) {
                            document.getElementById('myTranslateModal').style.display = 'none';
                        }
                    }
                    ...
                    xhttp.open("GET", 'TestServlet?sid='+sid+'&text='+selObj.toString()+'&targetlang='+selectElement.value, true);
                    xhttp.send();
