    ...
    var __webpack_modules__ = ([
        ...
        /***/ ((__unused_webpack_module, exports, __webpack_require__) => {
            ...
            const PDFViewerApplication = {
                ...
                rubberStampAnnotation: null,
                deleteConfirmationPrompt: null,
                stickyNotePrompt: null,
                deleteAnnotationConfirmationPrompt: null,
                signDocumentDialog: null,
                baseUrl: "",
                _downloadUrl: "",
                ...
                async _initializeViewerComponents() {
                    ...
                    this.rubberStampAnnotation = new RubberStampAnnotation({
                        overlayName: 'rubberStampOverlay',
                    ...
                    this.deleteAnnotationConfirmationPrompt = new DeleteAnnotationConfirmationPrompt({
                        overlayName: 'confirmDeleteAnnotationOverlay',
                    ...
                    this.stickyNotePrompt = new StickyNotePrompt({
                        overlayName: 'stickyNoteOverlay',
                    ...
                    this.signDocumentDialog = new SignDocumentDialog({
                        overlayName: 'signDocumentOverlay',
                ...
                setInitialView(storedHash, {
                    ...
                    PDFViewerApplication.loadDocumentAnnotations();
                },
                _cleanup() {
                    if (!this.pdfDocument) {
                        return;
                ...
                saveAndLoadDocumentAnnotations() {
                    ...
                    for (var i = 0; i < PDFViewerApplication.documentAnnotations.length; i++) {
                        ...
                        annotation.tempId = annotation.annotationId;
                        //Added by Yash
                        parent.documentAnnotation(sid, docId, annotation.tempId, annotation.annotationType, revisionid);
                        break;
                    }
                },
                drawDocumentAnnotations(pageView, annCtx, pageNumber) {
                    ...
                    for (var i = 0; i < PDFViewerApplication.documentAnnotations.length; i++) {
                        ...
                        if (!documentAnnotation.ddeleted) {
                            ...
                            //Added by Yash
                            else if (documentAnnotation.annotationType === ANNOTATION_NOTING) {
                                html += "<div class='annotation annotation-noting'></div>";
                            } else if (documentAnnotation.annotationType === ANNOTATION_SIGN) {
                                html += "<div class='annotation annotation-sign'></div>";
                            } else if (documentAnnotation.annotationType === ANNOTATION_STAMP) {
                                html += "<div class='annotation annotation-stamp'></div>";
                            } else {
                ...
                createDocumentAnnotation(annotationType) {
                    if (PDFViewerApplication.pdfViewer.pagesRotation == 0) {
                        ...
                        //Added by Yash
                        else if (annotationType == ANNOTATION_NOTING) {
                            newAnnotation.colorRed = 166;
                            newAnnotation.colorGreen = 237;
                            newAnnotation.colorBlue = 157;
                            newAnnotation.text = "";
                        } else if (annotationType == ANNOTATION_SIGN) {
                            newAnnotation.colorRed = 167;
                            newAnnotation.colorGreen = 192;
                            newAnnotation.colorBlue = 232;
                            newAnnotation.text = "";
                        } else if (annotationType == ANNOTATION_STAMP) {
                            newAnnotation.colorRed = 167;
                            newAnnotation.colorGreen = 192;
                            newAnnotation.colorBlue = 232;
                            newAnnotation.text = "";
                ...
                selectDocumentAnnotation(ev) {
                    ...
                    //Added by Yash
                    if (ann.selected && ann.annotationType === ANNOTATION_NOTING) {
                        parent.documentAnnotation(sid, docId, ann.annotationId, ann.annotationType, "selected");
                    }
                    if (ann.selected && ann.annotationType === ANNOTATION_SIGN) {
                        console.log(ev)
                    }
                    if (ann.selected && ann.annotationType === ANNOTATION_STAMP) {
                        console.log(ev)
                    }
                },
                changeDocumentAnnotationColor(colorPicker) {
            ...
            function webViewerInitialized() {
                ...
                //Added by Yash
                document.getElementById('notingAnnotation').addEventListener('click', function () {
                    $('.canvasWrapper').eq(0).show();
                    $('.canvasWrapper').eq(1).show();
                    PDFViewerApplication.createDocumentAnnotation(ANNOTATION_NOTING);

                    parent.documentAnnotation(sid, docId, "", revisionid);
                });
            ...
            function webViewerPageRendered({
                ...
                if ((objOffsetVersion = objAgent.indexOf("Firefox")) != -1) {
                    ...
                    if(action === 'sign')
                        ...
                        PDFViewerApplication.createDocumentAnnotation(ANNOTATION_STAMP);*/
                }
            }
